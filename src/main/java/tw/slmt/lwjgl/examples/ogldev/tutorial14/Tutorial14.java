package tw.slmt.lwjgl.examples.ogldev.tutorial14;
...
import tw.slmt.lwjgl.examples.ogldev.Camera;
...
public class Tutorial14 {
	...
	private static final String WINDOW_TITLE = "Tutorial 14 - Camera Control - Part 1";
	private static final String VERT_SHADER_FILE = OgldevUtil.RESOURCE_DIR_PATH + "/tutorial14/shader.vs";
	private static final String FRAG_SHADER_FILE = OgldevUtil.RESOURCE_DIR_PATH + "/tutorial14/shader.fs";
	...
	public static void main(String[] args) {
		...
		// Create a camera and add it to the key callback function
		camera = new Camera();
		GLFW.glfwSetKeyCallback(windowHandle, new CameraKeyCallback(camera));
	...
	private static class CameraKeyCallback extends GLFWKeyCallback {
		
		private Camera camera;
		
		public CameraKeyCallback(Camera camera) {
			this.camera = camera;
		}
